...
do
  ...
  python train_timer.py --epochs 3 --device cuda --model skinny_small_unet --file_number $NUMBER
  python train_timer.py --epochs 3 --device cuda --model skinny_small_dsc_unet --file_number $NUMBER
  python train_timer.py --epochs 3 --device cuda --model skinny_small_lbc_unet --file_number $NUMBER
  python train_timer.py --epochs 3 --device cuda --model skinny_small_dsc_lbc_unet --file_number $NUMBER
  ...
  python train_timer.py --epochs 3 --device cpu --model skinny_small_unet --file_number $NUMBER
  python train_timer.py --epochs 3 --device cpu --model skinny_small_dsc_unet --file_number $NUMBER
  python train_timer.py --epochs 3 --device cpu --model skinny_small_lbc_unet --file_number $NUMBER
  python train_timer.py --epochs 3 --device cpu --model skinny_small_dsc_lbc_unet --file_number $NUMBER
