...
if __name__ == '__main__':
    ...
    with open(f'../results/illumination/{model_name}_eval_{args.evalset}-mean-acc-epoch.json', 'w') as fp:
        json.dump(acc_dict, fp)

    with open(f'../results/illumination/{model_name}_eval_{args.evalset}-mean-iou-epoch.json', 'w') as fp:
        json.dump(iou_dict, fp)

    with open(f'../results/illumination/{model_name}_eval_{args.evalset}-mean-loss-epoch.json', 'w') as fp:
