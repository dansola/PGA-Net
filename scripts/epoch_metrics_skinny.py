...
if __name__ == '__main__':
    ...
    with open(f'../results/val_set_skinny/{model_name}-mean-acc-epoch.json', 'w') as fp:
        json.dump(acc_dict, fp)

    with open(f'../results/val_set_skinny/{model_name}-mean-iou-epoch.json', 'w') as fp:
        json.dump(iou_dict, fp)

    with open(f'../results/val_set_skinny/{model_name}-mean-loss-epoch.json', 'w') as fp:
